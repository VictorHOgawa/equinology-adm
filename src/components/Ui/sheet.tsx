      ...
      >
        ...
        {onClose ? (
          <button
            onClick={onClose}
            type="button"
            className="ring-offset-background data-[state=open]:bg-secondary absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none"
          >
            {closeIcon}
          </button>
        ) : (
