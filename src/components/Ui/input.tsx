...
export const inputVariants = cva(
  " w-full text-primary  bg-background  border-default-600 dark:border-default-700  px-3 h-9    file:border-0 file:bg-transparent file:font-medium  read-only:leading-9 read-only:bg-background  disabled:cursor-not-allowed disabled:opacity-50  transition duration-300 ",
  {
    variants: {
      color: {
        default:
          "border-default-300 text-primary focus:outline-none focus:border-default-900 disabled:bg-default-200  placeholder:text-accent-foreground/50",
        primary:
