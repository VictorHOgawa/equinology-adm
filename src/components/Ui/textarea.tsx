...
export const textareaVariants = cva(
  "flex flex-1 bg-white/40 text-secondary w-full min-h-[80px]   px-3 py-[10px]   file:border-0 file:bg-transparent file:font-medium  read-only:bg-background  disabled:cursor-not-allowed disabled:opacity-50  transition duration-300 ",
  {
    variants: {
      color: {
        default:
          "border-default-300 text-secondary focus:outline-none focus:border-primary disabled:bg-default-200  placeholder:text-secondary",
        primary:
